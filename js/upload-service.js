...
function onFileInputChange(ev) {
    console.log('on fileinputchange');
...
function uploadImg(elForm, ev) {
    ...
    function onSuccess(uploadedImgId) {
        ...
        <a class="w-inline-block social-share-btn btn fb" href="https://www.facebook.com/sharer/sharer.php?u=${urlForShare}&t=${urlForShare}" title="Share on Facebook" target="_blank" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u=${uploadedImgId}&t=${uploadedImgId}'); return false;">
           Share   
        </a>`
    }
...
(function initService() {
    ...
    document.querySelector('.publish-form-container').innerHTML = 
        `<form class="publish-form" action="" method="POST" enctype="multipart/form-data" onsubmit="uploadImg(this, event)">
            ...
            <button type="submit" class="publish-btn btn">Publish</button>
        </form>`
